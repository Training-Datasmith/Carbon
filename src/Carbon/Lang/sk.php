...
$from_now = fn($time) => 'o ' . strtr($time, ['hodina' => 'hodinu', 'minúta' => 'minútu', 'sekunda' => 'sekundu']);
$ago = function ($time): string {
    ...
    $replacements_plural = ['/\b(?:hodiny|hodín)\b/' => 'hodinami', '/\b(?:minúty|minút)\b/' => 'minútami', '/\b(?:sekundy|sekúnd)\b/' => 'sekundami', '/\bdeň\b/' => 'dňom', '/\bdni\b/' => 'dňami', '/\bdní\b/u' => 'dňami', '/\b(?:týždne|týždňov)\b/' => 'týždňami', '/\b(?:mesiace|mesiacov)\b/' => 'mesiacmi', '/\b(?:roky|rokov)\b/' => 'rokmi'];
    foreach ($replacements + $replacements_plural as $pattern => $replacement) {
        $time = preg_replace($pattern, $replacement, (string) $time);
    }
    return "pred {$time}";
};
return ['year' => ':count rok|:count roky|:count rokov', 'a_year' => 'rok|:count roky|:count rokov', 'y' => ':count r', 'month' => ':count mesiac|:count mesiace|:count mesiacov', 'a_month' => 'mesiac|:count mesiace|:count mesiacov', 'm' => ':count m', 'week' => ':count týždeň|:count týždne|:count týždňov', 'a_week' => 'týždeň|:count týždne|:count týždňov', 'w' => ':count t', 'day' => ':count deň|:count dni|:count dní', 'a_day' => 'deň|:count dni|:count dní', 'd' => ':count d', 'hour' => ':count hodina|:count hodiny|:count hodín', 'a_hour' => 'hodina|:count hodiny|:count hodín', 'h' => ':count h', 'minute' => ':count minúta|:count minúty|:count minút', 'a_minute' => 'minúta|:count minúty|:count minút', 'min' => ':count min', 'second' => ':count sekunda|:count sekundy|:count sekúnd', 'a_second' => 'sekunda|:count sekundy|:count sekúnd', 's' => ':count s', 'millisecond' => ':count milisekunda|:count milisekundy|:count milisekúnd', 'a_millisecond' => 'milisekunda|:count milisekundy|:count milisekúnd', 'ms' => ':count ms', 'microsecond' => ':count mikrosekunda|:count mikrosekundy|:count mikrosekúnd', 'a_microsecond' => 'mikrosekunda|:count mikrosekundy|:count mikrosekúnd', 'µs' => ':count µs', 'ago' => $ago, 'from_now' => $from_now, 'before' => ':time pred', 'after' => ':time po', 'hour_after' => ':count hodinu|:count hodiny|:count hodín', 'minute_after' => ':count minútu|:count minúty|:count minút', 'second_after' => ':count sekundu|:count sekundy|:count sekúnd', 'hour_before' => ':count hodinu|:count hodiny|:count hodín', 'minute_before' => ':count minútu|:count minúty|:count minút', 'second_before' => ':count sekundu|:count sekundy|:count sekúnd', 'first_day_of_week' => 1, 'day_of_first_week_of_year' => 4, 'list' => [', ', ' a '], 'diff_now' => 'teraz', 'diff_yesterday' => 'včera', 'diff_tomorrow' => 'zajtra', 'formats' => ['LT' => 'HH:mm', 'LTS' => 'HH:mm:ss', 'L' => 'DD.MM.YYYY', 'LL' => 'DD. MMMM YYYY', 'LLL' => 'D. M. HH:mm', 'LLLL' => 'dddd D. MMMM YYYY HH:mm'], 'calendar' => ['sameDay' => '[dnes o] LT', 'nextDay' => '[zajtra o] LT', 'lastDay' => '[včera o] LT', 'nextWeek' => 'dddd [o] LT', 'lastWeek' => static fn(Carbon_Interface $date): string => match ($date->day_of_week) {

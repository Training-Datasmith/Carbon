...
return ['year' => ':count წელი', 'y' => ':count წელი', 'a_year' => '{1}წელი|[-Inf,Inf]:count წელი', 'month' => ':count თვე', 'm' => ':count თვე', 'a_month' => '{1}თვე|[-Inf,Inf]:count თვე', 'week' => ':count კვირა', 'w' => ':count კვირა', 'a_week' => '{1}კვირა|[-Inf,Inf]:count კვირა', 'day' => ':count დღე', 'd' => ':count დღე', 'a_day' => '{1}დღე|[-Inf,Inf]:count დღე', 'hour' => ':count საათი', 'h' => ':count საათი', 'a_hour' => '{1}საათი|[-Inf,Inf]:count საათი', 'minute' => ':count წუთი', 'min' => ':count წუთი', 'a_minute' => '{1}წუთი|[-Inf,Inf]:count წუთი', 'second' => ':count წამი', 's' => ':count წამი', 'a_second' => '{1}რამდენიმე წამი|[-Inf,Inf]:count წამი', 'ago' => static function ($time): string {
    $replacements = [
        // year
        'წელი' => 'წლის',
        // month
    ...
    $time = strtr($time, $replacements);
    return "{$time} ადრე";
}, 'diff_now' => 'ახლა', 'diff_today' => 'დღეს', 'diff_yesterday' => 'გუშინ', 'diff_tomorrow' => 'ხვალ', 'formats' => ['LT' => 'HH:mm', 'LTS' => 'HH:mm:ss', 'L' => 'DD/MM/YYYY', 'LL' => 'D MMMM YYYY', 'LLL' => 'D MMMM YYYY HH:mm', 'LLLL' => 'dddd, D MMMM YYYY HH:mm'], 'calendar' => ['sameDay' => '[დღეს], LT[-ზე]', 'nextDay' => '[ხვალ], LT[-ზე]', 'nextWeek' => static fn(Carbon_Interface $current, \Carbon\Carbon_Interface $other) => ($current->is_same_week($other) ? '' : '[შემდეგ] ') . 'dddd, LT[-ზე]', 'lastDay' => '[გუშინ], LT[-ზე]', 'lastWeek' => '[წინა] dddd, LT-ზე', 'sameElse' => 'L'], 'ordinal' => static function (?string $number): int|string {
    if ($number === 0) {
        return $number;
    }
    if ($number === 1) {
